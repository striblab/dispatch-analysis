...
module.exports = (sequelize, DataTypes) => {
  let model = sequelize.define(
    ...
    snakeCaseFields({
      ...
      callTime: {
        type: DataTypes.DECIMAL(),
        description: 'Number of seconds of the call in total.'
      },
      toQueueTime: {
        type: DataTypes.DECIMAL(),
        description: 'Number of seconds from firstKeyStroke to incidentInQueue.'
      },
      inQueueTime: {
        type: DataTypes.DECIMAL(),
        description:
          'Number of seconds from incidentInQueue to firstUnitAssigned.'
      },
      driveTime: {
        type: DataTypes.DECIMAL(),
        description:
          'Number of seconds from firstUnitAssigned to firstUnitArrived.'
      },
